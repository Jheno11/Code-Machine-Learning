...
for param in hyper:
    for dataset in datasets:
        # Read each dataset
        data_path = f"C:/UMN/JP/penelitian/Machine Learning/MachineLearning/data{dataset}.csv"
...
results_df.to_csv('C:/UMN/JP/penelitian/Final/NB_ALL_801010_RESULTS6.csv', index=False)
print("Results saved to 'NB_ALL_801010_RESULTS.csv'")
